      ...
      <Header>
        <Menu mode="horizontal">
          ...
          <Menu.Item>
            <Link href="/">
              <a className="brand">
                <img src="/images/favicon.png" alt="Brinks" style={{ width: '240px', height: '43px' }} />
          ...
          {!state.mobile && (
            <Menu.Item>
              <Link href="/apps/_otimizacaohard">
          ...
          <SubMenu title={<Avatar src="/images/avatar.jpg" />}>
            ...
            <Menu.Divider />
            <Menu.Item>
              <Link href="https://miro.com/app/board/uXjVPpJehwU=/?utm_source=notification&utm_medium=email&utm_campaign=daily-updates&utm_content=go-to-board">
                <a>Ajuda?</a>
              </Link>
            </Menu.Item>
